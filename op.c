                                   ...
                                   IS_TYPE(gvop, METHOD_NAMED))
                        {
                            ...
                            if (SvIS_TYPE(name, PV) && SvCUR(name)) {
                                ...
                                if (gvp) {
                                    ...
                                    gvf = *gvp;
                                    if (SvROK(gvf) &&
                                        SvIS_TYPE(SvRV((SV*)gvf), PVCV)) {
                                        cv = (CV*)SvRV((SV*)gvf);
                                        rcv = (SV*)gvf;
                                        SvREFCNT_inc_simple_void_NN(rcv);
                                    }
                                    else if (SvIS_TYPE(gvf, PVGV) &&
                                             (cv = GvCV(gvf))) {
                                        ;
                                    }
                                }
