...
The ability to free empty SV arenas. It's currently unstable, and might be
replaced by proper arena memory handling later.
See L<Internals/gc> and L<perlapi/sv_gc_arenas>
...
and classes. Calls DynaLoader::dl_unload_file on XS modules.
