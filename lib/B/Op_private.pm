...
$bits{$_}{7} = 'OPpLVAL_INTRO' for qw(aelem aslice cond_expr delete enteriter entersub enterxssub gvsv helem hslice int_padsv list lvavref lvref lvrefslice multiconcat multideref num_padsv oelem padav padhv padrange padsv pushmark refassign rv2av rv2gv rv2hv rv2sv split str_padsv uint_padsv);
...
our %ops_using = (
    ...
    OPpLVAL_INTRO            => [qw(aelem aslice cond_expr delete enteriter entersub enterxssub gvsv helem hslice int_padsv list lvavref lvref lvrefslice multiconcat multideref num_padsv oelem padav padhv padrange padsv pushmark refassign rv2av rv2gv rv2hv rv2sv split str_padsv uint_padsv)],
