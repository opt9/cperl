...
$bits{$_}{7} = 'OPpLVAL_INTRO' for qw(aelem aslice cond_expr delete enteriter entersub enterxssub gvsv helem hslice list lvavref lvref lvrefslice multiconcat multideref oelem padav padhv padrange padsv padsv2 pushmark refassign rv2av rv2gv rv2hv rv2sv split);
...
our %ops_using = (
    ...
    OPpLVAL_INTRO            => [qw(aelem aslice cond_expr delete enteriter entersub enterxssub gvsv helem hslice list lvavref lvref lvrefslice multiconcat multideref oelem padav padhv padrange padsv padsv2 pushmark refassign rv2av rv2gv rv2hv rv2sv split)],
